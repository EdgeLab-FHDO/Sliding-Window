...
SCRIPT VARIABLES
"""
#server_ports=[14151] # MODIFICATION - contains the port of each server the app connectes before-hand --> NO ADVANTEDGE
server_ports=[30171,30172,30173,30174,30175] # MODIFICATION  #listen to this ports for AdvantEDGE 
#the client should listen to all the servers in the scenario
