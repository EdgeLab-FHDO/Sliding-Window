...
log_path='/home/jaime/Desktop/code/AdvantEDGE/2020-04-11/code/HNA_Layer1/loggers/'
log_file_name='REAL-HDZ10-WINDOW-6SERVER.log'
...
hand_off_time=229000 #duration of the hand-off in milliseconds
...
def thread_PoA_change(vehicle_ID):
    ...
    while True:	
        PoA=q_PoA.get()
        myPoA_manager.change_PoA(vehicle_ID, PoA) #call mobility event on AdvantEDGE
