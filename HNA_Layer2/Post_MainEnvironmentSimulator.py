...
#MODIFICATION: This file NEEDS TO BE MODIFIED
    ...
    #uncomment [[RESTclient.handoff]] line to apply hand-off time
...
import logging
import RestClientSingle as RESTclient #Interacts with the REST-Server        #MODIFICATION-UNCOMMENT to use single server approach  UNCOMMENT ALSO HANDOFF CALL
...
log_path='/home/jaime/Desktop/code/AdvantEDGE/2020-04-11/code/HNA_Layer2/loggers/'
log_file_name='REAL-HDZ10-SINGLE-VM-L2-1.log'
...
hazard_generator=['equidistant',10] #sets how to create the hazard and the separation distance
#MODIFICATION - change the generation type above
hand_off_time=15700 #MODIFICATION: duration of the hand-off in milliseconds #Affects only in single-server
#MODIFICATION - change the time to see what happens
"""
QUEUE DECLARATION
"""
...
def thread_PoA_change(vehicle_ID):
    ...
    while True:	
        ...
        RESTclient.handoff(PoA,(hand_off_time/1000))  #MODIFICATION:  uncomment to apply hand-off
        if end_flag==0:
            break
        time.sleep(0.01)
